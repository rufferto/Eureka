...
public struct PostalAddress: PostalAddressType {
	...
	@available(iOS 9.0, *)
	public init(postalAddress: CNPostalAddress?) {
...
public class PostalAddressCell<T: PostalAddressType>: Cell<T>, CellType, PostalAddressCellConformance, UITextFieldDelegate {
	...
	func internalNavigationAction(sender: UIBarButtonItem) {
		...
		if streetTextField.isFirstResponder() {
			...
			sender == inputAccesoryView.previousButton ? streetTextField.becomeFirstResponder() : stateTextField.becomeFirstResponder()
		}
		else if stateTextField.isFirstResponder()  {
			sender == inputAccesoryView.previousButton ? cityTextField.becomeFirstResponder() : postalCodeTextField.becomeFirstResponder()
		}
		else if postalCodeTextField.isFirstResponder() {
			sender == inputAccesoryView.previousButton ? stateTextField.becomeFirstResponder() : countryTextField.becomeFirstResponder()
		}
		else if countryTextField.isFirstResponder() {
	...
	public override func updateConstraints(){
		...
		dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("V:|-\(cellPadding)-[streetTextField(\(textFieldHeight))]-\(textFieldMargin)-[streetSeparatorView(\(separatorViewHeight))]-\(textFieldMargin)-[cityTextField(\(textFieldHeight))]-\(textFieldMargin)-[citySeparatorView(\(separatorViewHeight))]-\(textFieldMargin)-[postalCodeTextField(\(textFieldHeight))]-\(textFieldMargin)-[postalCodeSeparatorView(\(separatorViewHeight))]-\(textFieldMargin)-[countryTextField]-\(cellPadding)-|", options: [], metrics: nil, views: views)
		dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("V:|-\(cellPadding)-[streetTextField(\(textFieldHeight))]-\(textFieldMargin)-[streetSeparatorView(\(separatorViewHeight))]-\(textFieldMargin)-[cityTextField(\(textFieldHeight))]-\(textFieldMargin)-[citySeparatorView(\(separatorViewHeight))]-\(textFieldMargin)-[stateTextField(\(textFieldHeight))]-\(textFieldMargin)-[stateSeparatorView(\(separatorViewHeight))]-\(textFieldMargin)-[countryTextField]-\(cellPadding)-|", options: [], metrics: nil, views: views)
		...
		if let imageView = imageView, let _ = imageView.image {
			...
			if let titleLabel = titleLabel, text = titleLabel.text where !text.isEmpty {
				...
				dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("H:|-[imageView]-[label]-[stateTextField]-\(textFieldMargin * 2.0)-[postalCodeTextField(\(postalCodeTextFieldWidth))]-|", options: [], metrics: nil, views: views)
				...
				dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("H:|-[imageView]-[label]-[stateSeparatorView]-\(textFieldMargin * 2.0)-[postalCodeSeparatorView(\(postalCodeTextFieldWidth))]-|", options: [], metrics: nil, views: views)
			}
			else{
				...
				dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("H:|-[imageView]-[stateTextField]-\(textFieldMargin * 2.0)-[postalCodeTextField(\(postalCodeTextFieldWidth))]-|", options: [], metrics: nil, views: views)
				...
				dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("H:|-[imageView]-[stateSeparatorView]-\(textFieldMargin * 2.0)-[postalCodeSeparatorView(\(postalCodeTextFieldWidth))]-|", options: [], metrics: nil, views: views)
			}
		}
		else{
			...
			if let titleLabel = titleLabel, let text = titleLabel.text where !text.isEmpty {
				...
				dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("H:|-[label]-[stateTextField]-\(textFieldMargin * 2.0)-[postalCodeTextField(\(postalCodeTextFieldWidth))]-|", options: [], metrics: nil, views: views)
				...
				dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("H:|-[label]-[stateSeparatorView]-\(textFieldMargin * 2.0)-[postalCodeSeparatorView(\(postalCodeTextFieldWidth))]-|", options: [], metrics: nil, views: views)
				...
				dynamicConstraints.append(NSLayoutConstraint(item: cityTextField, attribute: .Width, relatedBy: (row as? PostalAddressRowConformance)?.postalAddressPercentage != nil ? .Equal : .GreaterThanOrEqual, toItem: contentView, attribute: .Width, multiplier: multiplier, constant: 0.0))
				...
				dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("H:|-[stateTextField]-\(textFieldMargin * 2.0)-[postalCodeTextField(\(postalCodeTextFieldWidth))]-|", options: [], metrics: nil, views: views)
				...
				dynamicConstraints += NSLayoutConstraint.constraintsWithVisualFormat("H:|-[stateSeparatorView]-\(textFieldMargin * 2.0)-[postalCodeSeparatorView(\(postalCodeTextFieldWidth))]-|", options: [], metrics: nil, views: views)
			}
		}
